    ...
    <>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          >
            {intl.formatMessage({ id: 'pages.customers.new' })}
          </button>
        </div>
      </PageHeader>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className={`${isDarkMode ? 'bg-[var(--card-background)] border-white/5' : 'bg-white border-gray-200'} p-5 rounded-xl border`}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-gray-400">{intl.formatMessage({ id: 'pages.customers.total' })}</span>
            </div>
          ...
          <div className={`${isDarkMode ? 'bg-[var(--card-background)] border-white/5' : 'bg-white border-gray-200'} p-5 rounded-xl border`}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-gray-400">{intl.formatMessage({ id: 'pages.customers.avgTicket' })}</span>
            </div>
          ...
          <div className={`${isDarkMode ? 'bg-[var(--card-background)] border-white/5' : 'bg-white border-gray-200'} p-5 rounded-xl border`}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-gray-400">{intl.formatMessage({ id: 'pages.customers.retentionRate' })}</span>
            </div>
          ...
          <div className={`${isDarkMode ? 'bg-[var(--card-background)] border-white/5' : 'bg-white border-gray-200'} p-5 rounded-xl border`}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-gray-400">{intl.formatMessage({ id: 'pages.customers.churnRate' })}</span>
            </div>
          ...
          <div className={`p-4 border-b ${isDarkMode ? 'border-[#1E1E2E]' : 'border-gray-200'}`}>
            <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
              <div className={`flex-1 flex items-center gap-2 ${isDarkMode ? 'bg-[#1E1E2E]' : 'bg-gray-100'} px-3 py-2 rounded-lg`}>
                ...
                <input
                  type="text"
                  placeholder={intl.formatMessage({ id: 'pages.customers.searchPlaceholder' })}
            ...
            <table className="w-full">
              <thead>
                <tr className={`border-b ${isDarkMode ? 'border-[#1E1E2E]' : 'border-gray-200'}`}>
                  <th className="text-left p-4 text-sm font-medium text-gray-400">{intl.formatMessage({ id: 'pages.customers.customer' })}</th>
                  <th className="text-left p-4 text-sm font-medium text-gray-400">{intl.formatMessage({ id: 'pages.customers.totalSpent' })}</th>
                  <th className="text-left p-4 text-sm font-medium text-gray-400">{intl.formatMessage({ id: 'pages.domains.status' })}</th>
                  <th className="text-left p-4 text-sm font-medium text-gray-400">{intl.formatMessage({ id: 'pages.customers.transactions' })}</th>
                  <th className="text-left p-4 text-sm font-medium text-gray-400">{intl.formatMessage({ id: 'pages.customers.lastPurchase' })}</th>
                  ...
                  <tr key={customer.id} className={`border-b ${isDarkMode ? 'border-[#1E1E2E] hover:bg-[#1E1E2E]/50' : 'border-gray-200 hover:bg-gray-50'} transition-colors`}>
                    ...
                    <td className="p-4">
                      <span className={`text-sm px-2 py-1 rounded-full ${statusColors[customer.status as keyof typeof statusColors]}`}>
                        {customer.status === 'active' ? intl.formatMessage({ id: 'pages.domains.active' }) : intl.formatMessage({ id: 'pages.domains.inactive' })}
                      </span>
                    </td>
                    <td className="p-4">
